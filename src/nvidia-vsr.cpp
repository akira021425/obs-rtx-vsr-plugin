                           ...
                           uint32_t dst_width, uint32_t dst_height)
{
    ...
    status = NvCVImage_Create(src_width, src_height, NVCV_RGBA, NVCV_U8, NVCV_CHUNKY, NVCV_GPU, 1, &m_src_img);
    if (status != NVCV_SUCCESS) {
    ...
    status = NvCVImage_Create(dst_width, dst_height, NVCV_RGBA, NVCV_U8, NVCV_CHUNKY, NVCV_GPU, 1, &m_dst_img);
    if (status != NVCV_SUCCESS) {
